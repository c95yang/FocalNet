...
class EBlock(nn.Module):
    def __init__(self, out_channel, num_res):
        ...
        layers = [VSSG(in_chans=out_channel, patch_size_global=8, patch_size_local=2, forward_type="v4") for _ in range(num_res)]
...
class DBlock(nn.Module):
    def __init__(self, channel, num_res):
        ...
        #keep default: depth [2], dim [96], mlp_ratio=4.0
        layers = [VSSG(in_chans=channel, patch_size_global=8, patch_size_local=2, forward_type="v4") for _ in range(num_res)]
