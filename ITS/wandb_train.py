...
def _train(model, args):
   ...
   # criterion = Charbonnier().cuda()  
    ...
    wan = wandb.init(project="low-light", name='8lr1-1k')
...
#            nn.utils.clip_grad_value_(model.parameters(),1)
        ...
        # if ((epoch_idx<938) and (epoch_idx % args.save_freq == 0)) or \
        #     ((epoch_idx>937) and (epoch_idx % 10 == 0)):   
        ...
        scheduler.step()
        # if (epoch_idx==1) or  ((epoch_idx>937) and (epoch_idx % 20 == 0)):   
